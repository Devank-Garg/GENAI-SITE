...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-yellow-100 via-pink-100 to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 p-4">
      <div className="max-w-md w-full bg-white/90 dark:bg-gray-900/90 rounded-2xl shadow-lg p-8 flex flex-col items-center border-4 border-dashed border-blue-300 dark:border-pink-700">
        <h2 className="text-2xl font-bold mb-6 text-blue-700 dark:text-pink-300">Login</h2>
        <form className="w-full flex flex-col gap-4 mb-4" onSubmit={handleLogin}>
          ...
          <input
            ...
            className="px-4 py-2 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 pr-10"
            required
          />
          <button
            type="button"
        ...
        <p className="text-gray-700 dark:text-gray-300 text-sm">
          ...
          <Link href="/signup" className="text-blue-600 dark:text-pink-300 font-semibold hover:underline">Sign Up</Link>
        </p>
